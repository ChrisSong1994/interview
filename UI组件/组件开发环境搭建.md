...
[SCSS 和 LESS 相比有什么优势？](https://www.zhihu.com/question/34606506)
...
或者看此文[TypeScript 体系调研报告](https://juejin.im/post/59c46bc86fb9a00a4636f939)
...
市面上打包工具数不胜数,最火爆的当然是需要*配置工程师*专门配置的 webpack,但是在类库开发领域它有一个强大的对手就是 rollup。
